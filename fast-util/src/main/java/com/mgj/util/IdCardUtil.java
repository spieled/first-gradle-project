...
public class IdCardUtil {
    ...
    public static Region resolveRegionCode(String idCardNumber) {
        ...
        int provinceCode = regionCode/10000 * 10000;
        String regionName = Constants.EMPTY;
        String cityName = Constants.EMPTY;
        String provinceName = Constants.EMPTY;
        boolean regionGot = false, cityGot = false, provinceGot = false;
        for (Map.Entry<String, Integer> entry : IdCardGenerator.areaCode.entrySet()) {
            if (regionGot && cityGot && provinceGot) {
                break;
            }
            if (entry.getValue() == regionCode) {
            ...
            if (entry.getValue() == provinceCode) {
        ...
        return new Region(regionCode, cityCode, provinceCode, regionName, cityName, provinceName);
    }
}